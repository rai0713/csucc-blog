...
<template>
    <section class="mx-auto max-w-xl rounded-2xl border border-black/10 bg-white p-6 shadow-[0_18px_40px_rgba(15,23,42,0.08)] lg:p-10">
        ...
        <p class="mt-6 text-xs uppercase tracking-[0.35em] text-slate-500">Login</p>
        <h2 class="mt-3 text-3xl font-semibold text-slate-900">Sign in</h2>
        ...
        <p class="mt-6 text-sm text-slate-600">
            New here?
            <RouterLink class="font-semibold text-slate-900 underline decoration-black/20 underline-offset-4 transition hover:decoration-black" :to="{ name: 'register' }">
                Create an account
            </RouterLink>
        </p>
    </section>
